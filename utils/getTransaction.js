...
async function getTransactions(contractAddress) {
    let urlNormalTransaction = "https://api-sepolia.etherscan.io/api?module=account&action=txlist&address="
    +contractAddress + "&startblock=0&endblock=99999999&page=1&offset=10&sort=asc&apikey="+ API_KEY
